...
class DesktopConfig(object):
    ...
    def check_desktop(self, path):
        ...
        # Fix Başlangıcı
        decoded = decoded.replace("ç","c")
        decoded = decoded.replace("ş","s")
        decoded = decoded.replace("ı","i")
        decoded = decoded.replace("ö","o")
        decoded = decoded.replace("ü","u")
        decoded = decoded.replace("Ç","C")
        decoded = decoded.replace("Ş","S")
        decoded = decoded.replace("İ","I")
        decoded = decoded.replace("Ö","O")
        decoded = decoded.replace("Ü","U")
        # Fix Bitişi
